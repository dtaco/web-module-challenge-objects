...
const pasta = createMenuItem('pasta', '6', 'dinner');
const iceCream = createMenuItem('ice cream', '4', 'dessert');

console.log(pizza, pasta, iceCream);
...
*/
  ...
  function addReview(array, aName, aRating, someFeedback){
  
    const newReview = {name: aName, rating: aRating, feedback: someFeedback};
...
function getReviewByIndex(array, reviewIndex) {
  return `${array[reviewIndex].name} gave the restaurant a ${array[reviewIndex].rating} star review, and their feedback was: ${array[reviewIndex].feedback}`
}
